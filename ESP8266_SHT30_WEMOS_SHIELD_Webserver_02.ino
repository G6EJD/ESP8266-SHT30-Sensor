...
// Alternative server schemaand works with iPhone and iPad
...
WiFiClient client;
ESP8266WebServer server(80);    // Start server on port 80 (default for a web-browser
...
void display_temp_and_humidity() {// Wait for a client to connect and when they do process their requests
  String webpage = "";  
